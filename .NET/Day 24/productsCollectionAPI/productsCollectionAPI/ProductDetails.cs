namespace productsCollectionAPI
{
    public class ProductDetails
    {
        ...
        static List<ProductDetails> productsList = new List<ProductDetails>()
        {
            ...
            new ProductDetails { pId = 101, pName = "Coca Cola", pCategory = "Cold Drink", pIsInStock = true, pPrice = 50 },
            new ProductDetails { pId = 102, pName = "Nutella", pCategory = "Chocolate", pIsInStock = true, pPrice = 250 },
            ...
            new ProductDetails { pId = 107, pName = "Bourborne", pCategory = "Biscuits", pIsInStock = true, pPrice = 23 },
            new ProductDetails { pId = 108, pName = "Pringles", pCategory = "Junk Food", pIsInStock = true, pPrice = 28 },
            new ProductDetails { pId = 109, pName = "Hersheys", pCategory = "Chocolate", pIsInStock = false, pPrice = 100 },
            ...
            new ProductDetails { pId = 113, pName = "Bread", pCategory = "Grocery", pIsInStock = true, pPrice = 12 },
            new ProductDetails { pId = 114, pName = "Jam", pCategory = "Grocery", pIsInStock = false, pPrice = 18 },
        };
        #endregion
        ...
        {
            var name = from e in productsList
                       select pName;
            return productsList;
        }
